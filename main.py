...
async def init_db():
    try:
        async with aiosqlite.connect(DB_PATH) as c:
            ...
            await c.execute("""
CREATE TRABLE IF NOT EXISTS expenses(
...
""")
            ...
            await c.commit()
            print("Database Initiated successfully with write access")
    except Exception as e:
        print("Database Initialisation error {e}")
        raise

#Initialise database at module level
asyncio.run(init_db())
